...
export const orderSnapshots = pgTable('order_snapshots', {
    ...
    projectTsIdx: index('idx_shot_project_ts').on(table.projectId, table.snapshotTimestamp),
}));
...
export const orderEvents = pgTable('order_events', {
    ...
    projectTsIdx: index('idx_event_project_ts').on(table.projectId, table.timestamp),
