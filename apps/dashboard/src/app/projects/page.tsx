      ...
      <main style={{ width: '100%', maxWidth: 1280, margin: '0 auto', padding: '28px 28px 32px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
          <section>
            <div className="mb-2 flex items-center gap-3">
              <h1 className="text-[20px] font-medium" style={{ color: 'var(--text-primary)' }}>Portfolio Command Center</h1>
              <span className="inline-flex items-center gap-1 rounded-md bg-[#DCFCE7] text-[10px] font-medium uppercase tracking-[0.08em] text-[#166534]" style={pillBaseStyle}>
          ...
          <section>
            <div className="mb-3 flex items-center justify-between gap-3">
              ...
              <span className="inline-flex items-center rounded-lg bg-[#DCFCE7] text-[11px] font-medium text-[#166534]" style={{ minHeight: 30, padding: '6px 12px', lineHeight: 1 }}>
                {metrics.totalProjects || 1} {metrics.totalProjects === 1 ? 'active stream' : 'active streams'}
              </span>
            </div>
