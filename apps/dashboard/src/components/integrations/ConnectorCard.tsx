  ...
  return (
    ...
    >
      ...
      <div className="mt-4 flex items-center gap-2 border-t border-subtle pt-4">
        <button
          type="button"
          className="flex-1 rounded-lg border border-primary/20 bg-primary/10 px-3 py-2 text-xs font-semibold text-primary transition-all hover:bg-primary/15 disabled:cursor-not-allowed disabled:opacity-60"
